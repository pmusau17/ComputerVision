...
opt = SGD(lr=0.01, decay=0.01 / 40, momentum=0.95, nesterov=True)
...
#Since there are no template values to fill in, Keras will simply
#overwrite the existing serialized weights file whenever our monitoring metric improves
