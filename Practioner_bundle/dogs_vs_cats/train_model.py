...
# This works provided that the data was already shuffled *prior* to writing it to disk

db = h5py.File(args['db'],'r')
i = int(db['labels'].shape[0] * 0.75)

# define the set of parameters that we want to tune then start a 
# grid search we we evaluate our model for each value of C

print("[INFO] tuning hyperparameters...")
params = {"C":[0.001,0.001,0.01,0.1,1.0]}
