...
from sklearn.datasets import make_blobs #this function can be used to create "blobs" of normally distributed points, handy for testing out models from scratch
...
#good initialization is critical to training a neural network in a reasonable amount of time, so
#random initialization along with simple heuristics win out in the vast majority of circumstances
...
plt.figure()
plt.title("Data")
plt.scatter(testX[:, 0], testX[:, 1], c=testY.flatten(), marker="o", s=30)
